#!/usr/bin/env bash
# Verification: Navigation works across all 6 pages on desktop and mobile
...
echo "=== Value: Navigation Across All 6 Pages ==="
echo ""
...
npx playwright test \
  ...
  ".loop/verifications/playwright/value_navigation.spec.ts" \
  --reporter=list \
  2>&1
