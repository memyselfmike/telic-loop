...
const usePublishAction = (props) => {
  ...
  const doPublish = t5;
  let t6;
  $[18] !== doPublish || $[19] !== hasValidationErrors || $[20] !== isSyncing || $[21] !== publishScheduled || $[22] !== revision || $[23] !== t || $[24] !== toast || $[25] !== validationStatus.isValidating || $[26] !== validationStatus.revision ? (t6 = () => {
  ...
  }, $[18] = doPublish, $[19] = hasValidationErrors, $[20] = isSyncing, $[21] = publishScheduled, $[22] = revision, $[23] = t, $[24] = toast, $[25] = validationStatus.isValidating, $[26] = validationStatus.revision, $[27] = t6) : t6 = $[27];
  let t7;
  $[28] !== doPublish || $[29] !== hasValidationErrors || $[30] !== isSyncing || $[31] !== isValidating || $[32] !== publishScheduled || $[33] !== revision || $[34] !== t || $[35] !== toast || $[36] !== validationStatus.isValidating || $[37] !== validationStatus.revision ? (t7 = [isSyncing, doPublish, hasValidationErrors, publishScheduled, validationStatus.revision, revision, isValidating, validationStatus.isValidating, toast, t], $[28] = doPublish, $[29] = hasValidationErrors, $[30] = isSyncing, $[31] = isValidating, $[32] = publishScheduled, $[33] = revision, $[34] = t, $[35] = toast, $[36] = validationStatus.isValidating, $[37] = validationStatus.revision, $[38] = t7) : t7 = $[38], useEffect(t6, t7);
  let t8;
  ...
  let t9;
  $[42] !== changesOpen || $[43] !== currentPublishRevision || $[44] !== publishState ? (t9 = [changesOpen, publishState, currentPublishRevision], $[42] = changesOpen, $[43] = currentPublishRevision, $[44] = publishState, $[45] = t9) : t9 = $[45], useEffect(t8, t9);
  ...
  bb0: {
    ...
    if (published && !draft && !version) {
      let t122;
      $[55] !== t ? (t122 = t("action.publish.label"), $[55] = t, $[56] = t122) : t122 = $[56];
      const t132 = published?._updatedAt;
      let t142;
      $[57] !== t || $[58] !== t132 ? (t142 = getDisabledReason("ALREADY_PUBLISHED", t132, t), $[57] = t, $[58] = t132, $[59] = t142) : t142 = $[59];
      let t152;
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      let t122;
      $[63] !== t ? (t122 = t("action.publish.label"), $[63] = t, $[64] = t122) : t122 = $[64];
      let t132;
      $[65] !== currentUser ? (t132 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "publish-document", currentUser }), $[65] = currentUser, $[66] = t132) : t132 = $[66];
      let t142;
    ...
    let t13;
    $[70] !== publishScheduled || $[71] !== publishState?.status || $[72] !== t ? (t13 = publishState?.status === "published" ? t("action.publish.published.label") : publishScheduled ? t("action.publish.validation-in-progress.label") : publishState?.status === "publishing" ? t("action.publish.running.label") : t("action.publish.draft.label"), $[70] = publishScheduled, $[71] = publishState?.status, $[72] = t, $[73] = t13) : t13 = $[73];
    let t14;
    $[74] !== publishScheduled || $[75] !== publishState?.status || $[76] !== t || $[77] !== title ? (t14 = publishScheduled ? t("action.publish.waiting") : publishState?.status === "published" || publishState?.status === "publishing" ? null : title, $[74] = publishScheduled, $[75] = publishState?.status, $[76] = t, $[77] = title, $[78] = t14) : t14 = $[78];
