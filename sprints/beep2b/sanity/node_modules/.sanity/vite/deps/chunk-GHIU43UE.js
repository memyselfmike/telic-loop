...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-LANEQMWF.js")
});
...
var VersionModeHeader = (t0) => {
  ...
  let t22;
  $[2] !== documentVersions ? (t22 = documentVersions.flatMap(_temp$K), $[2] = documentVersions, $[3] = t22) : t22 = $[3];
...
var DiffViewDocument = (t0) => {
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = useActiveReleases(), [patchChannel] = (0, import_react2.useState)(_temp$I);
  let t2;
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react2.useState)(_temp$H), [rootElement, setRootElement] = (0, import_react2.useState)(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
var CanvasLinkedBannerContent = (t0) => {
  ...
  let t22;
  $[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t22 = () => setOpen(_temp$B), $[8] = t22) : t22 = $[8];
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(77), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react2.useState)(_temp$A), isLocked = editState?.transactionSyncLock?.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
...
var DocumentPanel = function(props) {
  ...
  bb1: {
    ...
    let t152;
    $[54] !== filteredReleases.currentReleases || $[55] !== filteredReleases.notCurrentReleases ? (t152 = [...filteredReleases.currentReleases, ...filteredReleases.notCurrentReleases].find(_temp$y), $[54] = filteredReleases.currentReleases, $[55] = filteredReleases.notCurrentReleases, $[56] = t152) : t152 = $[56];
...
var usePublishAction = (props) => {
  const $ = (0, import_compiler_runtime2.c)(85), {
    id,
    type,
    liveEdit,
    draft,
  ...
  const doPublish = t5;
  let t6;
  $[18] !== doPublish || $[19] !== hasValidationErrors || $[20] !== isSyncing || $[21] !== publishScheduled || $[22] !== revision || $[23] !== t2 || $[24] !== toast || $[25] !== validationStatus.isValidating || $[26] !== validationStatus.revision ? (t6 = () => {
  ...
  }, $[18] = doPublish, $[19] = hasValidationErrors, $[20] = isSyncing, $[21] = publishScheduled, $[22] = revision, $[23] = t2, $[24] = toast, $[25] = validationStatus.isValidating, $[26] = validationStatus.revision, $[27] = t6) : t6 = $[27];
  let t7;
  $[28] !== doPublish || $[29] !== hasValidationErrors || $[30] !== isSyncing || $[31] !== isValidating || $[32] !== publishScheduled || $[33] !== revision || $[34] !== t2 || $[35] !== toast || $[36] !== validationStatus.isValidating || $[37] !== validationStatus.revision ? (t7 = [isSyncing, doPublish, hasValidationErrors, publishScheduled, validationStatus.revision, revision, isValidating, validationStatus.isValidating, toast, t2], $[28] = doPublish, $[29] = hasValidationErrors, $[30] = isSyncing, $[31] = isValidating, $[32] = publishScheduled, $[33] = revision, $[34] = t2, $[35] = toast, $[36] = validationStatus.isValidating, $[37] = validationStatus.revision, $[38] = t7) : t7 = $[38], (0, import_react2.useEffect)(t6, t7);
  let t8;
  $[39] !== currentPublishRevision || $[40] !== publishState ? (t8 = () => {
  ...
  }, $[39] = currentPublishRevision, $[40] = publishState, $[41] = t8) : t8 = $[41];
  let t9;
  $[42] !== changesOpen || $[43] !== currentPublishRevision || $[44] !== publishState ? (t9 = [changesOpen, publishState, currentPublishRevision], $[42] = changesOpen, $[43] = currentPublishRevision, $[44] = publishState, $[45] = t9) : t9 = $[45], (0, import_react2.useEffect)(t8, t9);
  const telemetry = useTelemetry();
  let t10;
  $[46] !== doPublish || $[47] !== draft?._createdAt || $[48] !== published || $[49] !== revision || $[50] !== syncState.isSyncing || $[51] !== telemetry || $[52] !== validationStatus.isValidating || $[53] !== validationStatus.revision ? (t10 = () => {
  ...
  }, $[46] = doPublish, $[47] = draft?._createdAt, $[48] = published, $[49] = revision, $[50] = syncState.isSyncing, $[51] = telemetry, $[52] = validationStatus.isValidating, $[53] = validationStatus.revision, $[54] = t10) : t10 = $[54];
  const handle = t10;
  let t11;
  bb0: {
    if (release && version) {
    ...
    if (published && !draft && !version) {
      let t122;
      $[55] !== t2 ? (t122 = t2("action.publish.label"), $[55] = t2, $[56] = t122) : t122 = $[56];
      const t132 = published?._updatedAt;
      let t142;
      $[57] !== t2 || $[58] !== t132 ? (t142 = getDisabledReason("ALREADY_PUBLISHED", t132, t2), $[57] = t2, $[58] = t132, $[59] = t142) : t142 = $[59];
      let t152;
      $[60] !== t122 || $[61] !== t142 ? (t152 = {
        tone: "default",
        icon: PublishIcon,
        label: t122,
        title: t142,
        disabled: true
      }, $[60] = t122, $[61] = t142, $[62] = t152) : t152 = $[62], t11 = t152;
      break bb0;
    }
    if (!isPermissionsLoading && !permissions?.granted) {
      let t122;
      $[63] !== t2 ? (t122 = t2("action.publish.label"), $[63] = t2, $[64] = t122) : t122 = $[64];
      let t132;
      $[65] !== currentUser ? (t132 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "publish-document", currentUser }), $[65] = currentUser, $[66] = t132) : t132 = $[66];
      let t142;
      $[67] !== t122 || $[68] !== t132 ? (t142 = {
        tone: "default",
        icon: PublishIcon,
        label: t122,
        title: t132,
        disabled: true
      }, $[67] = t122, $[68] = t132, $[69] = t142) : t142 = $[69], t11 = t142;
      break bb0;
    }
    ...
    let t13;
    $[70] !== publishScheduled || $[71] !== publishState?.status || $[72] !== t2 ? (t13 = publishState?.status === "published" ? t2("action.publish.published.label") : publishScheduled ? t2("action.publish.validation-in-progress.label") : publishState?.status === "publishing" ? t2("action.publish.running.label") : t2("action.publish.draft.label"), $[70] = publishScheduled, $[71] = publishState?.status, $[72] = t2, $[73] = t13) : t13 = $[73];
    let t14;
    $[74] !== publishScheduled || $[75] !== publishState?.status || $[76] !== t2 || $[77] !== title ? (t14 = publishScheduled ? t2("action.publish.waiting") : publishState?.status === "published" || publishState?.status === "publishing" ? null : title, $[74] = publishScheduled, $[75] = publishState?.status, $[76] = t2, $[77] = title, $[78] = t14) : t14 = $[78];
    const t15 = disabled || publishScheduled ? null : "Ctrl+Alt+P";
    let t16;
    $[79] !== handle || $[80] !== t12 || $[81] !== t13 || $[82] !== t14 || $[83] !== t15 ? (t16 = {
      disabled: t12,
      tone: "default",
      label: t13,
      icon: PublishIcon,
      ...
      shortcut: t15,
      onHandle: handle
    }, $[79] = handle, $[80] = t12, $[81] = t13, $[82] = t14, $[83] = t15, $[84] = t16) : t16 = $[84], t11 = t16;
  }
  return t11;
};
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t3 = subject.asObservable().pipe(distinctUntilChanged(), debounceTime(500), switchMap((document2) => isSanityDocument2(document2) ? from(resolveProductionUrl({
    document: document2
  })) : of(void 0)), distinctUntilChanged(), catchError(_temp$l)), $[4] = resolveProductionUrl, $[5] = t3) : t3 = $[5], useObservable(t3);
}
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./index2-7KKREGKO.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index3-6IVD43BE.js"))
};
...
function ChangesTabs(props) {
  ...
  let t31;
  return $[66] !== t17 || $[67] !== t22 || $[68] !== t24 || $[69] !== t27 || $[70] !== t30 ? (t31 = (0, import_jsx_runtime2.jsxs)(FadeInFlex$1, { direction: "column", padding: 0, height: "fill", "data-ready": t22, ref: setParentRef, children: [
    t17,
    t24,
    t27,
    t30
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index4-Z7ZCLKTV.js")),
...
//# sourceMappingURL=chunk-GHIU43UE.js.map
