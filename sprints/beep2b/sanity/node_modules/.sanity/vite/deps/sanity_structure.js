...
function LinkToExistingPreview(props) {
  ...
  let t4;
  $[27] !== badgeProps ? (t4 = badgeProps ? (0, import_jsx_runtime.jsx)(Text, { size: 0, children: (0, import_jsx_runtime.jsx)(VersionInlineBadge, { $tone: badgeProps.tone, children: badgeProps.text }) }) : void 0, $[27] = badgeProps, $[28] = t4) : t4 = $[28];
  let t5;
