...
- **API Server**: FastAPI application on port 8000
  ...
  - SQLite database at `sprints/recipe-mgr-v2/data/recipes.db`
...
- **Frontend**: Vanilla JS SPA served as static files from `sprints/recipe-mgr-v2/frontend/`
